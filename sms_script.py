keywords = {
	...
	'END' : 'Did you mean END or end? Text TEEN to (478) 449 4383 to begin this program again.',
	...
	'NO' : 'You are not in shape to succeed, Please reevaluate your choices. Reply END to end the program.',
	'BOOST' : 'Reply STRONG for stronger cigarettes. Reply TIME for the longest lasting cigarettes.',
	'STRONG' : 'You replied STRONG. Do you even take this program seriously? Text END to end your subscription immediately. Text HOPELESS to restart your trial.',
	'TIME' : 'You replied TIME. Do you even take this program seriously? Text END to end yoursubscription immediately. Text HOPELESS to restart your trial.',
	'WANT' : 'That is not specific enough. Are you craving a cigarette? If so, reply with the keyword NEED.',
	...
	'BURN' : 'If you need immediate medical assistance, text SOS to call a professional team of cigarette (and occasionally water) burn specialists to evacuate your house and isolate the problem before giving you the treatment you deserve. If it is a minor burn, text RED to order and ship an ice cube.',
	'NEW' : 'Why would you need a cigarette for a nonsmoking reason? Are you juggling or swallowing them? Do you need psychological help? If so, reply YES. If not, reply TEEN to restart the program or END to end the program.',
